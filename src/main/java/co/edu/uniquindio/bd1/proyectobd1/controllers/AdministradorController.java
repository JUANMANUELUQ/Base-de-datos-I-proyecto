...
public class AdministradorController implements VentanaTabuladora {
    ...
    @FXML
    void municipio() {
        InterfazFXUtil.cargarVentana("/co/edu/uniquindio/bd1/proyectobd1/fxml/Municipios.fxml",panel,getClass());
    }

    @FXML
    void sucursal() {
        InterfazFXUtil.cargarVentana("/co/edu/uniquindio/bd1/proyectobd1/fxml/Sucursales.fxml",panel,getClass());
    }
    ...
    @FXML
    void auditorias() {
        InterfazFXUtil.cargarVentana("/co/edu/uniquindio/bd1/proyectobd1/fxml/Auditorias.fxml",panel,getClass());
    }
